    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar ">
            <ul>
                ...
                <li><a class="nav-link scrollto" href="#about" id="link-about">@lang('home.navbar.about')</a></li>
                <li><a class="nav-link scrollto" href="#journey" id="link-journey">@lang('home.navbar.journey')</a></li>
                <li><a class="nav-link scrollto" href="#position" id="link-position">@lang('home.navbar.positions')</a></li>
                <li><a class="nav-link scrollto" href="#magang" id="link-position">@lang('home.navbar.intern')</a></li>
                <li>
