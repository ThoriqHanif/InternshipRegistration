                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select
                                                                    ...
                                                                    <option value="" selected disabled>-- Periode --
                                                                    </option>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select
                                                                    ...
                                                                    <option value="" selected disabled>-- Posisi
                                                                        Magang --
                                                                    </option>
                                                                </select>
                                                                <p><small class="text-muted">Hanya menampilkan posisi dengan kuota tersisa sesuai pilihan periode</small></p>
                                                                @error('position_id')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                @enderror
                                                            </div>
    ...
    <script>
        $(document).ready(function() {
            $('#periode_id').on('change', function() {
                ...
                $('#position_id').empty().append('<option value="" selected disabled>Loading...</option>');

                if (periodeId) {
                    $.ajax({
                        url: '{{ route('available.position', ':periodeId') }}'.replace(':periodeId', periodeId),
                        type: 'GET',
                        dataType: 'json',
                        success: function(data) {
                            ...
                            $.each(data, function(key, position) {
                                $('#position_id').append('<option value="' + position
                                    .id + '">' + position.name + '</option>');
                            });
                        }
                    });
                } else {
