                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control  @error('full_name') is-invalid @enderror" type="text" value="{{$full_name}}" name="full_name" placeholder="Masukkan Nama Lengkap" disabled>
                                                @error('full_name')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control  @error('username') is-invalid @enderror" type="text" value="{{$username}}" name="username" placeholder="Masukkan Nama Panggilan" disabled>
                                                @error('username')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control @error('phone_number') is-invalid @enderror" type="number" value="{{$phone_number}}" name="phone_number" placeholder="Masukkan Telp" disabled>
                                                @error('phone_number')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-control @error('gender') is-invalid @enderror" name="gender" disabled>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control @error('school') is-invalid @enderror" type="text" value="{{$school}}" name="school" placeholder="Masukkan Asal Sekolah" disabled>
                                                @error('school')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="example-text-input" class="form-control-label">Jurusan / Prodi</label>
                                                <input class="form-control @error('major') is-invalid @enderror" type="text" value="{{$major}}" name="major" placeholder="Masukkan Jurusan" disabled>
                                                @error('major')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('address') is-invalid @enderror" type="text"
                                                    value="{{$address}}" name="address" placeholder="Masukkan Alamat" disabled>{{$address}}</textarea>
                                                    @error('address')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-control @error('position_id') is-invalid @enderror" name="position_id" disabled>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="datepicker">
                                                    <input type="date" id="start_date" class=" form-control @error('start_date') is-invalid @enderror" id="date" name="start_date" value="{{$start_date}}" disabled/>
                                                    @error('start_date')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" >
                                                    <input type="date" id="end_date" class="form-control  @error('end_date') is-invalid @enderror" id="date" name="end_date" value="{{$end_date}}" disabled/>
                                                    @error('end_date')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="fileCV" class="form-control-label">CV</label>
                                                <div class="custom-file">
                                                    <input class="custom-file-input @error('cv') is-invalid @enderror" type="file" id="fileCV" name="cv" accept=".pdf, .docx, .png" disabled>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="fileMotivation" class="form-control-label">Motivation Letter</label>
                                                <div class="custom-file">
                                                    <input class="custom-file-input @error('motivation_letter') is-invalid @enderror" type="file" id="fileMotivation" name="motivation_letter" accept=".pdf, .docx, .png" disabled>
                                                    <label class="custom-file-label" for="fileCV">Choose file</label>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    <input class="custom-file-input @error('cover_letter') is-invalid @enderror" type="file" id="fileSurat" name="cover_letter" accept=".pdf, .docx, .png" disabled>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    <input class="custom-file-input @error('portfolio') is-invalid @enderror" type="file" id="filePortfolio" name="portfolio" accept=".pdf, .docx, .png" disabled>
                                                    <label class="custom-file-label" for="fileSurat">Choose file</label>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="filefoto" class="form-control-label">Pas Foto</label>
                                                <div class="custom-file">
                                                    <input class="custom-file-input @error('photo') is-invalid @enderror" type="file" id="filefoto" name="photo" accept=".pdf, .docx, .png" disabled>
                                                    <label class="custom-file-label" for="fileSurat">Choose file</label>
                                                </div>
                                    ...
                                    <hr class="horizontal dark">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select form-control @error('status') is-invalid @enderror" name="status" disabled>
