                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form method="POST" action="{{ route('documents.show', $document->id) }}"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input
                                                                    ...
                                                                    type="text" value="{{ $document->intern->full_name }}"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="example-text-input"
                                                                    class="form-control-label">Tipe Dokumen</label>
                                                                <input
                                                                    ...
                                                                    value="{{
                                                                        ...
                                                                        ($document->type === 'etc' ? 'Lainnya' : $document->type))))) }}"
                                                                    name="type" readonly>
                                                                @error('email')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                @enderror
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control  @error('note') is-invalid @enderror" type="text" name="note" readonly>{{ $document->note }}</textarea>
                                                                @error('note')
                                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                                @enderror
                                                            </div>
                                                    ...
                                                    <div class="inline-block mt-3">
                                                        ...
                                                        <a href="{{ route('documents.index') }}" type="button" class="btn btn-md btn-primary mt-3"
                                                            >Kembali</a>
