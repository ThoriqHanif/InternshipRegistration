              ...
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Tanggal Mulai</b> <a class="float-right text-success">{{$intern->start_date}}</a>
                  </li>
                  <li class="list-group-item">
                    <b>Tanggal Selesai</b> <a class="float-right text-danger" >{{$intern->end_date}}</a>
                  </li>
                    ...
                    <div class="timeline timeline-inverse">
                      ...
                      <div>
                        ...
                        <div class="timeline-item">
                          <span class="time"><i class="far fa-clock"></i> {{$intern->created_at}}</span>

                          <h3 class="timeline-header"><a href="#">Kadang Koding Indonesia </a> sent you an message</h3>

                          <div class="timeline-body">
                            Terimakasih {{$intern->full_name}} telah mendaftarkan diri untuk magang di Kadang Koding Indonesia. Mohon ditunggu untuk Update selanjutnya.
                          </div>
                      ...
                      <div>
                        ...
                        <div class="timeline-item">
                          ...
                          <h3 class="timeline-header"><a href="#">Kadang Koding Indonesia </a> sent you an update</h3>

                          <div class="timeline-body">
                            Hii {{$intern->full_name}}, terimakasih telah mendaftar magang di Kadang Koding Indonesia. Status pendaftaran anda <a href="">{{$intern->status}}</a>
                          </div>
                          <div class="timeline-footer">
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal" method="post" action="{{ url('profile')}}">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputName2" name="password" placeholder="Password" value="">
                        </div>
                      </div>
