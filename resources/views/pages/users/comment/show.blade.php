    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Komentar</h3>
                <p class="text-subtitle text-muted">Daftar Komentar dari Blog {{ $blog->title }}</p>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <a href="{{ route('comments.index') }}" class="btn btn-primary">Kembali</a>
                    </ol>
                </nav>
            </div>
        </div>
                            ...
                            <div class="comment-body">
                                ...
                                <div class="comment-actions">
                                    <button class="btn icon icon-left btn-primary me-2 text-nowrap btn-reply"
                                        ...
                                        data-blog-id="{{ $comment->blog_id }}" data-comment-id="{{ $comment->id }}"
                                        data-message="{{ $comment->message }}" data-comment-name="{{ $comment->name }}">
