            ...
            <div class="py-4">
                ...
                <div class="px-14 py-10 text-sm text-neutral-700">
                    <table class="w-full border-collapse border-spacing-0">
                        <thead>
                            <tr>
                                <td class="border-b-2 border-main pb-3 pl-3 font-bold text-main">Tanggal</td>
                                <td class="border-b-2 border-main pb-3 pl-2 font-bold text-main">Presensi</td>
                                <td class="border-b-2 border-main pb-3 pl-2 text-right font-bold text-main">Jam Hadir
                                </td>
                                <td class="border-b-2 border-main pb-3 pl-2 text-center font-bold text-main">Instansi
                                </td>
                                <td class="border-b-2 border-main pb-3 pl-2 text-center font-bold text-main">Nama
                                    Project
                                </td>
                                <td class="border-b-2 border-main pb-3 pl-2 text-right font-bold text-main">Pekerjaan
                                </td>
                                <td class="border-b-2 border-main pb-3 pl-2 pr-3 text-right font-bold text-main">
                                    Keterangan
                                </td>
                                <td class="border-b-2 border-main pb-3 pl-2 pr-3 text-right font-bold text-main">Status
                                </td>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($intern->reports as $report)
                                <tr>
                                    ...
                                    <td class="border-b py-3 pl-2 text-center">{{ $report->job }}</td>
                                    <td class="border-b py-3 pl-2 text-center">{{ $report->description }}</td>
                                    <td class="text-capitalize border-b py-3 pl-2 pr-3 text-right">
                                        {{ $report->status }}
                                    </td>
                                </tr>
                            @endforeach
