<a href="{{ route('blogs.show', ['locale' => app()->getLocale(), 'slug' => $blog->slug]) }}" class="btn btn-sm bg-primary text-white font-weight-bold text-xs"
    data-toggle="tooltip" data-placement="top" title="Detail blog">
    <i class="bi bi-eye"></i>
</a>
<a href="{{ route('blogs.edit', ['locale' => app()->getLocale(), 'slug' => $blog->slug]) }}" class="btn btn-sm bg-warning text-white font-weight-bold text-xs"
    data-toggle="tooltip" data-placement="top" title="Edit blog">
    <i class="bi bi-pencil-square"></i>
</a>
<form style="display: inline" action="{{ route('blogs.destroy', ['slug' => $blog->slug]) }}" method="POST">
    @csrf
    @method('DELETE')
