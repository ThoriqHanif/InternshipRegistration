        ...
        <div style="background:#f9f9f9;background-color:#f9f9f9;Margin:0px auto;max-width:600px;">
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tbody>
                    <tr>
                        <td
                            style="border-bottom:#1D6DCC solid 8px;direction:ltr;font-size:0px;padding:20px 0;text-align:center;vertical-align:top; ">
                            <!--[if mso | IE]>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:64px;">
                                                            ...
                                                            <img height="auto" src="https://i.imgur.com/w9sLjpy.png"
                                    ...
                                    <tr style="">
                                        <td align="center"
                                            ...
                                            <div
                                                style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:28px;font-weight:bold;line-height:1;text-align:center;color:#555; margin-top: 15px;">
                                                Balasan Komentar
                                            </div>
                                    ...
                                    <tr>
                                        <td align="left"
                                            ...
                                            <div
                                                ...
                                                Hai, {{ $comment->name }}<br></br>
                                                Komentar Anda pada"{{ $blog->title }}" mendapatkan balasan dari {{ $comment->name }}. <br>
                                                Berikut detailnya : <br>
                                                Komentar Baru: "{{ $comments->messages }}" <br><br>

                                                Jika ingin melihat dan merespons komentar, silakan klik link di bawah ini:
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="left"
                                            ...
                                            <div
                                                ...
                                                <a href="https://www.kadangkoding.co.id"
                                                    style="color:#2F67F6">kadangkoding.co.id</a>
                                            </div>
                                                    ...
                                                    <tr>
                                                        <td align="center"
                                                            ...
                                                            <div
                                                                ...
                                                                </script> CV Kadang Koding Indonesia. All
                                                                rights reserved.
                                                            </div>
