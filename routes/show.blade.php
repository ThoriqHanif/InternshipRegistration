                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <p class="mt-2">{{ $evaluation->intern->full_name }}
                                                    </p>
                                                </div>
                                                <div class="form-group">
                                                    <label for="name">Asal Sekolah</label>
                                                    <p class="mt-2">{{ $evaluation->intern->school }}
                                                    </p>
                                                </div>
                                                <div class="form-group">
                                                    <label for="name">Posisi Magang</label>
                                                    <p class="mt-2">
                                                        {{ $evaluation->intern->position->name ?? '-' }}</p>
                                                </div>
                                                <div class="form-group">
                                                    <label for="name">Tanggal Mulai</label>
                                                    <p class="mt-2">{{ \Carbon\Carbon::parse($evaluation->intern->start_date)->format('d F Y') }}
                                                    </p>
                                                </div>
                                                <div class="form-group">
                                                    <label for="name">Tanggal Selesai</label>
                                                    <p class="mt-2">{{ \Carbon\Carbon::parse($evaluation->intern->end_date)->format('d F Y') }}
                                                    </p>
                                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <p class="text-uppercase text-sm">Evaluation Information</p>
                                        <hr class="horizontal-dark">
                                        <div class="form-group">
                                            <label>Nama</label>
                                            <p class="mt-2">{{ $evaluation->name }}</p>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            @if ($fileUrl)
                                                ...
                                                @if ($fileExtension == 'png')
                                                    <div class="mt-3">
                                                        <a data-fancybox data-caption="File {{ $evaluation->name }}"
                                                            href="{{ $fileUrl }}">
